...
export const docsNavigation = [
  ...
  { id: "page-layout", label: "Page Layout", group: "Layouts", icon: PanelTop },
  { id: "detail-page-layout", label: "Detail Page Layout", group: "Layouts", icon: PanelRight },
  { id: "app-shell", label: "App Shell", group: "Layouts", icon: AppWindow },
  { id: "section", label: "Section", group: "Composition", icon: Columns2 },
  { id: "form-section", label: "Form Section", group: "Composition", icon: Columns2 },
  { id: "info-panel", label: "Info Panel", group: "Composition", icon: ShieldPlus },
  { id: "metric-card", label: "Metric Card", group: "Composition", icon: ReceiptText },
  { id: "property-list", label: "Property List", group: "Composition", icon: ListCollapse },
] satisfies DocsNavigationItem[];

const docsNavigationGroups = ["Forms", "Selection", "Feedback", "Overlay", "Navigation", "Data Display", "Layouts", "Composition"] as const;
